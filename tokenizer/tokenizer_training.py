...
"""
From https://github.com/lucidrains/magvit2-pytorch
"""
...
if __name__ == "__main__":
    ...
    trainer = VideoTokenizerTrainer(
        tokenizer,
        dataset_folder='tokenizer/data/videos',  # folder of either videos or images, depending on setting below
    ...
    ema_tokenizer = cast(EMA, trainer.ema_tokenizer)
